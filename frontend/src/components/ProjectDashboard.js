...
const ProjectDashboard = () => {
    ...
    const handleCreateProject = async () => {
        ...
        setError('');
        try {
            const result = await api.createProject(projectName || 'Untitled Project');
            if (result.id) {
    ...
    const handleCloneProject = async () => {
        ...
        setError('');
        try {
            const result = await api.cloneProject(githubUrl, projectName || null);
            if (result.id) {
                navigate(`/projects/${result.id}`);
            } else {
    ...
    return (
        <div className="project-dashboard">
            <div className="dashboard-header">
                ...
                <p className="tagline">Your collaborative cloud IDE</p>
            </div>
            ...
            <div className="dashboard-actions">
                ...
                <div className="action-card" onClick={() => setShowCloneModal(true)}>
